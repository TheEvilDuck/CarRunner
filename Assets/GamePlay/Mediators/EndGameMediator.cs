...
public class EndGameMediator : IDisposable
{
    ...
    public EndGameMediator(EndOfTheGame endGameUI, SceneLoader sceneLoader, State gameOverState, State winState, PauseButton pauseButton, CarControllerMediator carControllerMediator, LevelsDatabase levelDatabase, PlayerData playerData, IPlayerInput playerInput)
    {
